...
% with different sampling instances 1T,1.1T,1.2T
...
legend('1 T','1.1 T','1.2 T','Theory'); xlabel('Eb/No, dB');
axis([0 10 10^-5 0.5]); grid on;
ylabel('Bit Error Rate'); 
title('BER curve for BPSK modulation for sinc pulse shaping at different sampling instances');